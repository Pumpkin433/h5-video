	...
	<view class="question-bg">
		<view class="question-bg-1">
			<view class="question-setval">
				<uni-countdown :show-day="false" background-color="transparent" color="white" :show-colon="true" :day="0" :hour="0"
				 :minute="0" :second="this.second" :reset="this.reset" @timeup="timeUp"></uni-countdown>
			</view>
			...
			<view class="question-bg-2">
				...
				<view class="modal-end-bg" v-show="isModalEnd === true">
					<view class="modal-end-t">
						...
						<view class="modal-end-r">
							<!-- <img src="http://h5-activity.oss-cn-shanghai.aliyuncs.com/h5-basketball/jiangbei.png" alt=""> -->
						</view>
					</view>
				...
				<view class="modal-share-bg" v-show="isModalShare === true">
					...
					<view class="modal-share-d">
						...
						<view class="modal-share-d-r"><img src="http://h5-activity.oss-cn-shanghai.aliyuncs.com/h5-basketball/m-share-qrcode.png"
							 alt="" /></view>
					</view>
				</view>
				<!-- 分享弹框结束 -->
				...
				<view class="modal-answer-error-bg" v-show="isModalAnswerError === true">
					<view class="modal-a-circle"><img src="http://h5-activity.oss-cn-shanghai.aliyuncs.com/h5-basketball/a-error-circle.png"
						 alt="" /></view>
					<h4>很抱歉您的回答错误</h4>
					<h3>
						获得了
				...
				<view class="modal-answer-timeout-bg" v-show="isModalAnswerTimeout === true">
					<view class="modal-t-circle"><img src="http://h5-activity.oss-cn-shanghai.aliyuncs.com/h5-basketball/a-timeout-circle.png"
						 alt="" /></view>
					<h4>很抱歉您已经超时</h4>
					<h3>
						获得了
