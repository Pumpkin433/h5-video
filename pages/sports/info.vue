<template>
	<view class="uni-flex uni-column " :class="infoTye === 1 ? 'rank-bg' : 'rule-bg'">
		...
		<scroll-view v-if="infoClick == 1" :scroll-top="scrollTop" scroll-y="true" class="info-c scroll-Y" @scroll="scroll" >
			<!-- <view id="demo1" class="scroll-view-item "> -->
				<view class="rank-3-t">
					<view class="rank-3-img rank-3-img-m-1">
						<img src="https://h5-activity.oss-cn-shanghai.aliyuncs.com/basketball-v2/info-jin.png" alt="">
					</view>
					<view class="rank-3-img rank-3-img-m-2">
						<img src="https://h5-activity.oss-cn-shanghai.aliyuncs.com/basketball-v2/info-yin.png" alt="">
					</view>
					<view class="rank-3-img rank-3-img-m-3">
						<img src="https://h5-activity.oss-cn-shanghai.aliyuncs.com/basketball-v2/info-tong.png" alt="">
					</view>
				</view>
				<view class="rank-3-d">
					<view class="rank-3-d-item rank-3-img-m-1">
						<view class="rank-3-name">
							菟安妮小仙姑
						</view>
			...
			<view class="my-score">
				<view class="my-score-c">
					<view class="my-score-c-l">
						NO 16
					</view>
					<view class="my-score-c-m">
						菟安妮小仙姑
					</view>
				...
				<view class="my-score-img">
					<img src="https://h5-activity.oss-cn-shanghai.aliyuncs.com/basketball-v2/my-score.png" alt="">
				</view>
		...
		<scroll-view v-if="infoClick == 2"  scroll-y="true" class="rule-rule scroll-Y" @scroll="scroll" >
			<view class="rule-rule-t">
				游戏规则
			</view>
			<view class="rule-rule-c">
				1.活动时间：5月1日~5月7日；  <br>
				2.APP用户每天有3次答题机会，外部用户每天有1次答题机会；  <br>
				3.每答对1题获得1积分，答错或倒计时结束没有回答，则游戏结束；
			</view>
			<view class="rule-prize-t">
				游戏奖励
			</view>
			<view class="rule-prize-c">
				<view class="rule-prize-c-l">
					<img src="https://h5-activity.oss-cn-shanghai.aliyuncs.com/basketball-v2/prize-icon.png" alt="">
				</view>
