<template>
	<view class="index-bg">
		...
		<view class="index-d">
			<div class="index-d-bg" id="downloadButton"><span>开始挑战</span></div>
			<!-- <div class="index-d-bg" @tap="turn_question" id="downloadButton"><span>开始挑战</span></div> -->
		</view>
		...
		new OpenInstall(
			{
				...
				apkFileName: 'National Sport.apk',
				/*可选参数，是否优先考虑拉起app，以牺牲下载体验为代价*/
				preferWakeup: true,
				/*自定义遮罩的html*/
				mask: function() {
					return "<div id='openinstall_shadow' style='position:fixed;left:0;top:0;background:rgba(0,0,0,0.5);filter:alpha(opacity=50);width:100%;height:100%;z-index:10000;'>请用手机自带浏览器打开，下载全民体育app</div>";
				},
