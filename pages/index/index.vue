<template>
	<view class="video-bg">
		...
		<view class="uni-flex uni-column comment-container" id="comment-list">
			<view class="flex-item comment-t">【公告】今晚APP直播间留言的用户，将有机会赢得xx/xxxxxx（6个），xxxxxx主场老特拉福德玩具积木（共2个）</view>
		</view>
...
export default {
	data() {
		return {
			...
			danmuSockets: '',
			noticeText: '【公告】请中奖的小伙伴添加，reallay官方微信账号：rich_lay'
		};
	},
