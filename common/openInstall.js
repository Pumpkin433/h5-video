export default function(e, n, t) {
	...
	function i(e) {
		...
		for (var t in e) {
			...
			if ("[object Array]" == Object.prototype.toString.call(r))
				for (var i = 0; i < r.length; i++) null != r[i] && void 0 !== r[i] && n.push(encodeURIComponent(t) + "=" +
					encodeURIComponent(r[i]));
	...
	function c(e) {
		var n = new t,
			...
			i = e.url,
			o = e.method;
		r && "string" != typeof r && (r = R.stringify(r)), "POST" != o && r && (i = i + (i.indexOf("?") > -1 ? "&" : "?") +
			r, r = null), n.onreadystatechange = function() {
			if (4 == n.readyState) {
				if (200 == n.status) {
		...
		try {
			...
			try {
				n.setRequestHeader && e.contentType && n.setRequestHeader("Content-Type", e.contentType), e.timeout && (n.timeout =
					e.timeout)
			} catch (e) {}
			n.send(r || null)
		} catch (e) {}
	...
	function u() {
		...
		if (e && "function" == typeof e.getContext)
			for (var t = ["webgl", "webgl2", "experimental-webgl2", "experimental-webgl"], r = 0; r < t.length; r++) {
				...
				if (o) {
					var a = {};
					a.context = i, a.version = o.getParameter(o.VERSION), a.vendor = o.getParameter(o.VENDOR), a.sl_version = o.getParameter(
						o.SHADING_LANGUAGE_VERSION), a.max_texture_size = o.getParameter(o.MAX_TEXTURE_SIZE);
	...
	function s(t, r, i) {
		...
		for (var v, g, m = !1, b = r ? r + ((new Date).getTime() + (i || 1)) + "-" : null, h = 0; h < p.length; h++) {
			try {
				if (v = p[h], y && (v.style.position = "absolute", v.style.top = "-100px"), n.body.appendChild(v), "SELECT" === v.nodeName)
					v.focus();
				else if ("INPUT" === v.nodeName || "TEXTAREA" === v.nodeName) {
					b && (v.value = x(O(v.value) + b));
					var C = v.hasAttribute("readonly");
					C || v.setAttribute("readonly", ""), v.select(), v.setSelectionRange(0, v.value.length), C || v.removeAttribute(
						"readonly")
				} else {
	...
	function d(e, t) {
		var r, i, o = !1;
		o ? (r = "hidden", i = "qbrowserVisibilityChange") : void 0 !== n.hidden ? (r = "hidden", i = "visibilitychange") :
			void 0 !== n.msHidden ? (r = "msHidden", i = "msvisibilitychange") : void 0 !== n.webkitHidden && (r =
				"webkitHidden", i = "webkitvisibilitychange");
		var a = function(e) {
	...
	var p = 2,
			...
			return setTimeout(t, 3e3),
				function(c, u) {
					...
					i.push({
						fn: c,
						ctx: u
					}), "complete" === n.readyState || "loading" !== n.readyState && !n.documentElement.doScroll ? t() : a || (n.addEventListener ?
						(n.addEventListener("DOMContentLoaded", t, !1), e.addEventListener("load", t, !1)) : (n.attachEvent(
							"onreadystatechange", r), e.attachEvent("onload", t)), a = !0)
				}
		}(),
		m = function() {},
		b = function() {
			function e(e, n) {
				var t, r, o, a, c = -1,
					u = e.length,
					l = [0, 0, 0, 0];
				for (t = []; ++c < u;) r = e[c], o = e[++c], l[0] = r >> 2, l[1] = (3 & r) << 4 | (o || 0) >> 4, c >= u ? l[2] = l[
					3] = 64 : (a = e[++c], l[2] = (15 & o) << 2 | (a || 0) >> 6, l[3] = c >= u ? 64 : 63 & a), t.push(i.charAt(l[0]),
					i.charAt(l[1]), i.charAt(l[2]), i.charAt(l[3]));
				var s = t.join("");
				return n ? s.replace(/=/g, "") : s
			}

			function n(e) {
				for (var n, t, r, o, a, c, u, l = [], s = 0; s < e.length;) o = i.indexOf(e.charAt(s++)), a = i.indexOf(e.charAt(s++)),
					c = i.indexOf(e.charAt(s++)), u = i.indexOf(e.charAt(s++)), n = o << 2 | a >> 4, t = (15 & a) << 4 | c >> 2, r =
					(3 & c) << 6 | u, l.push(n), 64 != c && l.push(t), 64 != u && l.push(r);
				return l
			}
			...
			function t(e) {
				...
				if (/^[\x00-\x7f]*$/.test(e))
					...
					for (; ++t < r;) n = e.charCodeAt(t), n < 128 ? i.push(n) : n < 2048 ? i.push(n >> 6 | 192, 63 & n | 128) : i.push(
						n >> 12 | 224, n >> 6 & 63 | 128, 63 & n | 128);
				return i
			}
			...
			function r(e) {
				var n, t, r, i = [],
					o = 0;
				for (n = t = r = 0; o < e.length;) n = e[o], n < 128 ? (i.push(String.fromCharCode(n)), o++) : n > 191 && n < 224 ?
					(t = e[o + 1], i.push(String.fromCharCode((31 & n) << 6 | 63 & t)), o += 2) : (t = e[o + 1], r = e[o + 2], i.push(
						String.fromCharCode((15 & n) << 12 | (63 & t) << 6 | 63 & r)), o += 3);
				return i.join("")
			}
		...
		A = function() {
			...
			function i(e) {
				for (var t, i, o, a, c = e.split("\r\n"), u = 0; u < c.length; u++) {
					...
					a && !l[a] && /[0-9]{1,3}(\.[0-9]{1,3}){3}/.test(a) && ("0.0.0.0" == a || 0 == a.indexOf("127.") || 0 == a.indexOf(
						"169.254") || 3758096384 == (4026531840 & r(a)) || (l[a] = 1, s.push(a)))
				}
				s.length && n()
			}
			var o, c, u, l = {},
		...
		S = {
			...
			inhrf: function(e) {
				...
				t.setAttribute("type", "text/javascript"), t.innerHTML =
					'(function(){var a = document.createElement("a");a.style.display = "none";a.href = "' + e.replace(/"/g, '\\"') +
					'";document.body.appendChild(a);a.click();})()', n.body.appendChild(t)
			},
			open: function(n) {
				e.open(n)
			}
		...
		I = function(e, t) {
			...
			function i(e, n, t) {
				p.run(function() {
					t = t || {}, n && k && (e = !1), R && n && (m(), P = s(R, T, w));
					var i;
					n && (i = r, _ && c({
						method: "POST",
						url: _
					})), x && e ? f(O, x, i, t.timeout || A) : i && i()
				})
			}
			...
			this.wakeupOrInstall = function(e) {
				...
				function() {
					var n = e.channelCode || I.parseUrlParams().channelCode,
						r = {
							channelCode: n,
					...
					i.length > 7 && (i = i.substring(0, 7)), l(function(a) {
						c({
							url: o(I.server + "/web/" + e.appKey + "/" + i + "/init", r, a),
							method: "POST",
							contentType: "text/plain;charset=utf-8",
							data: t,
							success: function(e) {
								g(function() {
									e.sh && (v = u(e.sh)), y = e.fu, b = e.fm, C = e.ft, x = e.su, O = e.sm, A = e.st, R = e.ph ? E(e.ph) :
										null, T = e.pyp ? E(e.pyp) : null, w = e.pye ? parseInt(E(e.pye) || "0") : 0, k = e.dsoi, n = e.channelCode,
										_ = e.csu, p.ready()
								})
							}
						})
	...
	}, I.parseUrlParams = r, I.docReady = g, I.server = "https://openinstall.io", I.wakeupOrInstall = function(e, n, t,
		r, i) {
		n ? f(e, n, function() {
			S[t](r)
		}, i) : S[t](r)
